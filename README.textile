...
Model-driven (MDD) Tooling used to generate the source files for this project:

* "Xtext":www.eclipse.org/Xtext/
* "Xtext Protected Regions":https://github.com/danieldietrich/xtext-protectedregions
* "Saentity DSL":https://github.com/soluvas/saentity
...
h2. Details about layout and deployment options
